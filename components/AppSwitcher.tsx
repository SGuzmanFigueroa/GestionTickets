  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          role="menu"
          className={`absolute z-50 mt-2 w-72 max-sm:fixed max-sm:inset-x-4 max-sm:top-14 max-sm:mt-0 max-sm:w-auto rounded-lg border border-slate-200 bg-white p-2 shadow-xl dark:border-slate-700 dark:bg-slate-800 ${
